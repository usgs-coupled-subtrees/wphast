/*=========================================================================
  ...
  Module:    $RCSfile: vtkPointWidget2.h,v $
  Language:  C++
...
=========================================================================*/
// .NAME vtkPointWidget2 - position a point in 3D space
// .SECTION Description
...
// vtkPointWidget2, like any 3D widget, will work with the current interactor
// style. That is, if vtkPointWidget2 does not handle an event, then all other
// registered observers (including the interactor style) have an opportunity
// to process the event. Otherwise, the vtkPointWidget2 will terminate the
...
// the vtkPointWidget2 will appear. (See superclass documentation for
...
// the x-y-z axes by using the "shift" key.) The vtkPointWidget2 produces as
...
#ifndef __vtkPointWidget2_h
#define __vtkPointWidget2_h
...
public:
  ...
  static vtkPointWidget2 *New();

  vtkTypeRevisionMacro(vtkPointWidget2,vtk3DWidget);
...
private:
  vtkPointWidget2(const vtkPointWidget2&);  //Not implemented
  void operator=(const vtkPointWidget2&);  //Not implemented
};
