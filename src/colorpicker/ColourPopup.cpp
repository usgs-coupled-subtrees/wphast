...
ColourTableEntry CColourPopup::m_crColours[] = 
{
    ...
    { RGB(  0,   0, 255),    _T("Blue")            },
    { RGB(102, 102, 153),    _T("Blue-Gray")       },
    { RGB(128, 128, 128),    _T("Gray-50%")        },
...
void CColourPopup::OnCancelMode()
{
	CWnd::OnCancelMode();
