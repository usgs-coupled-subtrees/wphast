...
#ifndef __vtkDelaunay2DEx_h
#define __vtkDelaunay2DEx_h
...
class vtkDelaunay2D : public vtkPolyDataAlgorithm
{
public:
  vtkTypeRevisionMacro(vtkDelaunay2DEx,vtkPolyDataAlgorithm);
  ...
  const std::list< std::pair<vtkIdType, vtkIdType> >& GetBadPoints()const;
  //}}
...
protected:
  ...
  //{{
  std::list< std::pair<vtkIdType, vtkIdType> > BadPoints;
  //}}
