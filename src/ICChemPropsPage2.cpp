...
CICChemPropsPage2::CICChemPropsPage2()
	...
	, SolutionProperty(this, true, true, true)
	, EquilibriumPhasesProperty(this, true, true, true)
	, SurfaceProperty(this, true, true, true)
	, ExchangeProperty(this, true, true, true)
	, GasPhaseProperty(this, true, true, true)
	, SolidSolutionsProperty(this, true, true, true)
	, KineticsProperty(this, true, true, true)
	, Default(false)
	, FlowOnly(false)
{
	TRACE("In %s\n", __FUNCTION__);
